...
public class Solution {
    public class TableInterfaceWrapper implements ATableInterface{
        ...
        public TableInterfaceWrapper(ATableInterface ati) {this.ati=ati;}
        ...
        @Override
        public String getHeaderText() {return this.ati.getHeaderText().toUpperCase();}

        @Override
        public void setHeaderText(String newHeaderText) {this.ati.setHeaderText(newHeaderText);}
    }
